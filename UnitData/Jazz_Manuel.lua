...
DefineClass.Jazz_Manuel = {
	...
	Bio = T(890000000003705, --[[ModItemUnitDataCompositeDef Jazz_Manuel Bio]] "Urban Brawl / Night Ops. Муж Фатимы, отец Пако. Внедрился в армию Арулько по просьбе Мигеля, был раскрыт и бежал в лес. Отряд встречает его блуждающим в лесах Тракона. Статы 70+, Dexterity 91. Одиночка, привыкший полагаться только на себя после провала операции."),
	Nationality = "Arulco",
