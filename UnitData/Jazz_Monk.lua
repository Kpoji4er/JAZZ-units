...
DefineClass.Jazz_Monk = {
	...
	IsMercenary = true,
	Name = T(890000000003802, --[[ModItemUnitDataCompositeDef Jazz_Monk Name]] "Виктор «Монк» Колесников"),
	...
	Bio = T(890000000003805, --[[ModItemUnitDataCompositeDef Jazz_Monk Bio]] "Wildfire. Ветеран Чеченской войны, не любит вспоминать родину. Статы 80–90, Marksmanship 94, прочие навыки 20–30. Одиночка, действует лучше вдали от толпы. Симпатизирует Лоре; недолюбливает Ивана и Конрада."),
	Nationality = "Russia",
