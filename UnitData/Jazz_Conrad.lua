...
DefineClass.Jazz_Conrad = {
	...
	IsMercenary = true,
	Name = T(890000000002202, --[[ModItemUnitDataCompositeDef Jazz_Conrad Name]] "Лейтенант Конрад Джиллет"),
	...
	Bio = T(890000000002205, --[[ModItemUnitDataCompositeDef Jazz_Conrad Bio]] "Сильнейший из доступных местных наёмников: статы 75–80, Leadership 51 и полноценный инструктор, Marksmanship 95. Дружит с Игги и Стефаном; терпеть не может пьяного Ларри; не умеет плавать (флейвор). Дорог — берёт заметно выше рынка и торгуется жёстко."),
	Nationality = "Germany",
