...
DefineClass.Jazz_Kulba = {
	...
	IsMercenary = true,
	Name = T(890000000004715, "Джон Кульба"),
	Nick = T(890000000004716, "Кульба"),
	AllCapsNick = T(890000000004717, "КУЛЬБА"),
	Bio = T(890000000004718, "Ветеран Urban Brawl. Статы 55–60, Marksmanship 95, Mechanical 88. Жена умерла от рака вскоре после спасения из Арулко. Ультра-патриот, любит Гаса, недолюбливает Ивана, Игоря и Рикошета."),
	Nationality = "USA",
