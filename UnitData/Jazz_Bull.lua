...
DefineClass.Jazz_Bull = {
	...
	IsMercenary = true,
	Name = T(890000000004302, --[[ModItemUnitDataCompositeDef Jazz_Bull Name]] "Джон «Бык» Питерс"),
	...
	Bio = T(890000000004305, --[[ModItemUnitDataCompositeDef Jazz_Bull Bio]] "Один из самых дешёвых наёмников AIM: Health 96, Strength 98, Agility/Dexterity ~50, Wisdom 64, Marksmanship 72. Агрессивен и бьёт первым. Дружит с Нейлсом; не любит Биффа."),
	Nationality = "USA",
