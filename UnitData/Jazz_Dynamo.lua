...
DefineClass.Jazz_Dynamo = {
	...
	IsMercenary = true,
	Name = T(890000000003402, --[[ModItemUnitDataCompositeDef Jazz_Dynamo Name]] "Грег «Динамо» Дункан"),
	...
	Bio = T(890000000003405, --[[ModItemUnitDataCompositeDef Jazz_Dynamo Bio]] "Статы 55–65, Marksmanship 68, Mechanical 67, Wisdom 78. Бывший заключённый с извращённым чувством юмора насчёт ранений — знает, куда бить, чтобы противник ослеп или запаниковал. Дружит с Шенком и Кровью; не любит Мясо. Дёшев, готов работать почти за идею."),
	Nationality = "Hungary",
