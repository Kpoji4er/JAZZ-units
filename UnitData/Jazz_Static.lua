...
DefineClass.Jazz_Static = {
	...
	IsMercenary = true,
	Name = T(890000000004102, --[[ModItemUnitDataCompositeDef Jazz_Static Name]] "Кирк «Статик» Стивенсон"),
	...
	Bio = T(890000000004105, --[[ModItemUnitDataCompositeDef Jazz_Static Bio]] "Статы 60–80, Strength 59, Dexterity 95, Wisdom 60, Mechanical 99. Боится насекомых. Дружит со Спайдером и обкуренным Ларри; не любит трезвого Ларри, Ротмана, Блэйда; недолюбливает швейцарцев."),
	Nationality = "USA",
