...
DefineClass.JAZZ_Legion_GunnerT4_MercGunner = {
	...
	Explosives = 20,
	Medical = 20,
	Portrait = "Mod/Dv3mFVN/EnemyPortraits/Legion/MercGunner.png",
	BigPortrait = "UI/Enemies/LegionRaider",
	Name = T(890000000000508, --[[ModItemUnitDataCompositeDef JAZZ_Legion_GunnerT4_MercGunner Name]] "Наемник Пулеметчик"),
	Randomization = true,
	elite = true,
