...
DefineClass.Jazz_Madman = {
	...
	IsMercenary = true,
	Name = T(890000000002102, --[[ModItemUnitDataCompositeDef Jazz_Madman Name]] "Кевин «Бешеный» Камерон"),
	...
	Bio = T(890000000002105, --[[ModItemUnitDataCompositeDef Jazz_Madman Bio]] "Алмаз среди местных: физикалы за 90, механика 68, псих без страха. Клеится к Лиске при каждом удобном случае. После кампании в Арулько готов уйти в MERC — дёшево, лишь бы была движуха и техника под рукой."),
	Nationality = "USA",
