...
DefineClass.Jazz_Dimitri = {
	...
	Bio = T(890000000002005, --[[ModItemUnitDataCompositeDef Jazz_Dimitri Bio]] "Статы под 70, ловкость 50, механика 71. Забывчивый — может остановиться посреди хода и переспросить, куда шёл. Дружит с Мигелем и Карлосом; недолюбливает Ротмана за высокомерие. Крафтит и точит собственные метательные ножи — бонус к ведущему навыку броска."),
	Nationality = "Russia",
