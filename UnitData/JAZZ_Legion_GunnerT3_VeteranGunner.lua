...
DefineClass.JAZZ_Legion_GunnerT3_VeteranGunner = {
	...
	Explosives = 10,
	Medical = 30,
	Portrait = "Mod/Dv3mFVN/EnemyPortraits/Legion/VeteranGunner.png",
	BigPortrait = "UI/Enemies/LegionRaider",
	Name = T(890000000000507, --[[ModItemUnitDataCompositeDef JAZZ_Legion_GunnerT3_VeteranGunner Name]] "Подавитель"),
	Randomization = true,
	Affiliation = "Legion",
	StartingLevel = 14,
