...
DefineClass.Jazz_Ricochet = {
	...
	IsMercenary = true,
	Name = T(890000000004602, --[[ModItemUnitDataCompositeDef Jazz_Ricochet Name]] "Тим «Рикошет» Саттонн"),
	...
	Bio = T(890000000004605, --[[ModItemUnitDataCompositeDef Jazz_Ricochet Bio]] "Заниженные для ближнего боя статы (Agility 60, Strength 75), но Marksmanship 88 говорит о хорошей руке для бросков. Одиночка. Уважает Злобного; терпеть не может Сидни, Вики и Скоупа."),
	Nationality = "USA",
