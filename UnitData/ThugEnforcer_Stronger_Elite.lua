UndefineClass('ThugEnforcer_Stronger_Elite')
DefineClass.ThugEnforcer_Stronger_Elite = {
	__parents = { "UnitData" },
	...
	Name = T(944480351626, --[[ModItemUnitDataCompositeDef ThugEnforcer_Stronger_Elite Name]] "Badass Enforcer"),
	Randomization = true,
	Affiliation = "Thugs",
	StartingLevel = 10,
