...
DefineClass.Jazz_Vicious = {
	...
	IsMercenary = true,
	Name = T(890000000002702, --[[ModItemUnitDataCompositeDef Jazz_Vicious Name]] "Жан-Пьер «Злобный» Вио"),
	...
	Bio = T(890000000002705, --[[ModItemUnitDataCompositeDef Jazz_Vicious Bio]] "Статы 80–90, Wisdom 55, Marksmanship 82. Агрессивный французский боец ближнего боя, клеится к Лиске, Пауку и — по слухам из JA2 — к некой Лаве. Терпеть не может британцев."),
	Nationality = "France",
