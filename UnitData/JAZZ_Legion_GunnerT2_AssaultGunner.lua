...
DefineClass.JAZZ_Legion_GunnerT2_AssaultGunner = {
	...
	Explosives = 10,
	Medical = 0,
	Portrait = "Mod/Dv3mFVN/EnemyPortraits/Legion/AssaultGunner.png",
	BigPortrait = "UI/Enemies/LegionRaider",
	Name = T(890000000000510, --[[ModItemUnitDataCompositeDef JAZZ_Legion_GunnerT2_AssaultGunner Name]] "Коммандо"),
	Randomization = true,
	Affiliation = "Legion",
	StartingLevel = 8,
