...
DefineClass.Jazz_Miguel = {
	...
	IsMercenary = true,
	Name = T(890000000003202, --[[ModItemUnitDataCompositeDef Jazz_Miguel Name]] "Мигель Кордона"),
	...
	Bio = T(890000000003205, --[[ModItemUnitDataCompositeDef Jazz_Miguel Bio]] "Статы 70–80, Leadership 98 — лучший лидер повстанцев Арулько, прошедший ночные операции и рукопашный бой. Дружит с Карлосом, Айрой и Тенью; не сходится характером с неким Игги (упоминание из JA2, персонаж пока не заведён в моде); недолюбливает немцев за колониальное наследие."),
	Nationality = "Arulco",
