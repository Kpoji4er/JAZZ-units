...
DefineClass.Jazz_Henning = {
	...
	IsMercenary = true,
	Name = T(890000000004002, --[[ModItemUnitDataCompositeDef Jazz_Henning Name]] "Хеннинг фон Браниц"),
	...
	Bio = T(890000000004005, --[[ModItemUnitDataCompositeDef Jazz_Henning Bio]] "Wildfire — эрзац-замена Гасу. Статы 70–80, Wisdom 96, Leadership 76, Marksmanship 92. Клаустрофоб, не переносит замкнутые помещения. Аристократичный тактик, предпочитает командовать издалека, но не боится взять оружие сам, если требуется. Дружит со Штайгером и Лорой; недолюбливает Тора и Рикошета."),
	Nationality = "Germany",
