...
DefineClass.Jazz_Gaston = {
	...
	IsMercenary = true,
	Name = T(890000000003502, --[[ModItemUnitDataCompositeDef Jazz_Gaston Name]] "Гастон Кавалье"),
	...
	Bio = T(890000000003505, --[[ModItemUnitDataCompositeDef Jazz_Gaston Bio]] "Urban Brawl. Статы 80–90, Marksmanship 94, прочие навыки 20+. Не умеет плавать (флейвор). Работает с крыш и в темноте, флиртует с Тоской, Бансом и Лиской. Не выносит Злобного за конкуренцию по части дам и Биффа за трусость."),
	Nationality = "France",
